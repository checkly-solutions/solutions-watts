// await page.goto('https://greenstone.brisk.ag/')

import { test, expect } from '@playwright/test';
import { createChecklyContext } from '../../utils/checklyRequestContext';
import { signIn, sessionHandler } from '../../utils/auth-client';

const envName = 'GREENSTONE PROD';
const envUrl = 'https://greenstone.brisk.ag/';
const envVariableName = 'PROD_GREENSTONE_TOKEN';
